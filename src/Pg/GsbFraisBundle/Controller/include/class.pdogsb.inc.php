 ...
 */
    ...
    */
    ...
    public function addVoiture($numImmat, $marque, $modele, $couleur){
        $requestuest = "INSERT INTO `gsbphp`.`vehicule` (`numImmat`, `marque`, `dateNaissEleve`, `modele`, `couleur`) VALUES ('".$numImmat."', '".$marque."', '".$modele."', '".$couleur."')";
        $q = gemahPdo::$monPdo->prepare($requestuest);
        $q->execute();
