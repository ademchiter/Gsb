...
class HomeController extends Controller
{
    ...
    public function validerconnexionAction(){
        ...
        if(!is_array($visiteur)){
            ...
            $session->set('idnumImmat',$visiteur['idnumImmat']);
            $session->set('refTablette',$visiteur['refTablette']);
            $session->set('memoire',$visiteur['memoire']);
            $session->set('statut',$visiteur['statut']);
            return $this->render('PgGsbFraisBundle::accueil.html.twig');
        }
    } 
